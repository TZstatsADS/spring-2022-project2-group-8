                ...
                sidebarLayout(
                    sidebarPanel(
                      p(strong("Data Resources"),
                        ...
                        p(),
                        tags$a(href = "https://www1.nyc.gov/site/tlc/about/tlc-trip-record-data.page", "NYC Yellow Taxi Data", target = "_blank"),
                        p(),
			    tags$a(href = "http://web.mta.info/developers/turnstile.html", "NYC Yellow Taxi Data", target = "_blank"),
